# -*- coding: utf-8 -*-
"""ДЗ Регулярные выражения и основы синтаксического разбора.ipynb
...
def acronym():
    ...
    # хотел сделать без переменной result, сразу положить все в return и вывести через f- строку, 
    # но анаконда ругается, что в f-строку нельзя положить обратный слеш \
    # Буду очень признателен, если подскажите как его экранировать?
